...
import Group1 from 'src/assets/images/IG-1.png'
import Group2 from 'src/assets/images/IG-2.png'
import Group3 from 'src/assets/images/IG-3.png'
import commentsLen from 'src/assets/images/IGCommentslen24.jpg'
import commentsWords from 'src/assets/images/IGCommentswords24.jpg'
import commentsAvg from 'src/assets/images/IGavgComments.jpg'
import WordCloud from 'src/assets/images/WordCloudIG.jpg'
import topics from 'src/assets/images/IGtopic24.jpg'
import sentiments from 'src/assets/images/IGsentiment24.jpg'
import Sentimentscore from 'src/assets/images/IGsentimentscore.jpg'
  ...
  return (
    <CRow>
      <CCol xs={12}>
        ...
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Average words in a Comment</strong>
          </CCardHeader>
          <CCardBody>
            <CImage align="center" rounded src={commentsAvg} width={700} height={370} />
          </CCardBody>
        </CCard>
        <CCard className="mb-4">
          <CCardHeader>
